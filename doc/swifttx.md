...
This mechanism has been integrated into Bitcore-Node-Collegicoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CollegicoinCLG/insight-api-collegicoin#web-socket-api](https://github.com/CollegicoinCLG/insight-api-collegicoin#web-socket-api)
* API: [https://github.com/CollegicoinCLG/insight-api-collegicoin#swifttx-transactions](https://github.com/CollegicoinCLG/insight-api-collegicoin#swifttx-transactions)
...
By default, the Collegicoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Collegicoin Core daemon:
