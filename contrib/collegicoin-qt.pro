...
HEADERS += src/bignum.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/collegicoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/qt/collegicoin.cpp \
           src/qt/collegicoinstrings.cpp \
...
RESOURCES += src/qt/collegicoin.qrc src/qt/collegicoin_locale.qrc

TRANSLATIONS += src/qt/locale/collegicoin_bg.ts \
                src/qt/locale/collegicoin_de.ts \
                src/qt/locale/collegicoin_en.ts \
                src/qt/locale/collegicoin_es.ts \
                src/qt/locale/collegicoin_fi.ts \
                src/qt/locale/collegicoin_fr.ts \
                src/qt/locale/collegicoin_it.ts \
                src/qt/locale/collegicoin_ja.ts \
                src/qt/locale/collegicoin_pl.ts \
                src/qt/locale/collegicoin_pt.ts \
                src/qt/locale/collegicoin_ru.ts \
                src/qt/locale/collegicoin_sk.ts \
                src/qt/locale/collegicoin_sv.ts \
                src/qt/locale/collegicoin_vi.ts \
                src/qt/locale/collegicoin_zh_CN.ts \
                src/qt/locale/collegicoin_zh_TW.ts
