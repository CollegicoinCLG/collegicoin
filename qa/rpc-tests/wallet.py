...
#   c) node1 mines 32 blocks, so now node 0 has 500000CLG, node 1 has 4250CLG, node2 has none.
#   d) node0 sends 601 CLG to node2, in two transactions (301 CLG, then 300 CLG).
