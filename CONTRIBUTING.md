Contributing to Collegicoin Core
==================================

The Collegicoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Collegicoin Core project, and is not to be
confused with overall Collegicoin Network Protocol consensus changes.

Whether a pull request is merged into Collegicoin Core rests with the project merge
...
Patches that change Collegicoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Collegicoin consensus, it must have been
...
The project leader is the release manager for each Collegicoin Core release.
