...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::CLG)
    {
    }
                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    // CLG Available
    bool showCLGAvailable = settingShowAllBalances || clgAvailableBalance != nTotalBalance;
    bool showWatchOnlyCLGAvailable = showCLGAvailable || nAvailableWatchBalance != nTotalWatchBalance;
    ui->labelBalanceText->setVisible(showCLGAvailable || showWatchOnlyCLGAvailable);
    ui->labelBalance->setVisible(showCLGAvailable || showWatchOnlyCLGAvailable);
    ui->labelWatchAvailable->setVisible(showCLGAvailable && showWatchOnly);

    // CLG Pending
    bool showCLGPending = settingShowAllBalances || unconfirmedBalance != 0;
    bool showWatchOnlyCLGPending = showCLGPending || watchUnconfBalance != 0;
    ui->labelPendingText->setVisible(showCLGPending || showWatchOnlyCLGPending);
    ui->labelUnconfirmed->setVisible(showCLGPending || showWatchOnlyCLGPending);
    ui->labelWatchPending->setVisible(showCLGPending && showWatchOnly);
    ...
    // CLG Locked
    bool showCLGLocked = settingShowAllBalances || nLockedBalance != 0;
    bool showWatchOnlyCLGLocked = showCLGLocked || nWatchOnlyLockedBalance != 0;
    ui->labelLockedBalanceText->setVisible(showCLGLocked || showWatchOnlyCLGLocked);
    ui->labelLockedBalance->setVisible(showCLGLocked || showWatchOnlyCLGLocked);
    ui->labelWatchLocked->setVisible(showCLGLocked && showWatchOnly);
