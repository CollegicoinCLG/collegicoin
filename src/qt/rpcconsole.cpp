...
// Repair parameters
const QString COLLEGICOINWALLET("-collegicoinwallet");
                                          ...
                                          banTableContextMenu(0)
{
    ...
    connect(ui->btn_collegicoinwallet, SIGNAL(clicked()), this, SLOT(walletCollegicoin()));
...
/** Restart wallet with "-collegicoinwallet" */
void RPCConsole::walletCollegicoin()
{
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Collegicoin RPC console.") + "<br>" +
