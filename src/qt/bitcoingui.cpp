                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Collegicoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Collegicoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Collegicoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Collegicoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CLG addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CLG addresses"));
    ...
    openAction->setStatusTip(tr("Open a collegicoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Collegicoin Core help message to get a list with possible Collegicoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Collegicoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Collegicoin network", "", count));
}
...
{
    QString strTitle = tr("Collegicoin Core"); // default title
