...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(CLG);
    unitlist.append(mCLG);
    unitlist.append(uCLG);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case CLG:
            return QString("tCLG");
        case mCLG:
            return QString("mtCLG");
        case uCLG:
            return QString::fromUtf8("μtCLG");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case CLG:
            return QString("CLG");
        case mCLG:
            return QString("Milli-CLG (1 / 1" THIN_SP_UTF8 "000)");
        case uCLG:
            return QString("Micro-CLG (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case CLG:
            return QString("TestCLGs");
        case mCLG:
            return QString("Milli-TestCLG (1 / 1" THIN_SP_UTF8 "000)");
        case uCLG:
            return QString("Micro-TestCLG (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
