...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Collegicoin Core collegicoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  collegicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded collegicoin transaction") + "\n" +
                               "  collegicoin-tx [options] -create [commands]   " + _("Create hex-encoded collegicoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded collegicoin transaction
