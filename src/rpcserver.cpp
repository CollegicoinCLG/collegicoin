...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Collegicoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Collegicoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"collegicoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"collegicoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"collegicoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"collegicoin", "masternodedebug", &masternodedebug, true, true, false},
        {"collegicoin", "startmasternode", &startmasternode, true, true, false},
        {"collegicoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"collegicoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"collegicoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"collegicoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"collegicoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"collegicoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"collegicoin", "mnbudget", &mnbudget, true, true, false},
        {"collegicoin", "preparebudget", &preparebudget, true, true, false},
        {"collegicoin", "submitbudget", &submitbudget, true, true, false},
        {"collegicoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"collegicoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"collegicoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"collegicoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"collegicoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"collegicoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"collegicoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"collegicoin", "checkbudgets", &checkbudgets, true, true, false},
        {"collegicoin", "mnsync", &mnsync, true, true, false},
        {"collegicoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12037/\n";
}
